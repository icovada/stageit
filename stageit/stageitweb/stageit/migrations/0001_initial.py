# Generated by Django 3.0.2 on 2020-01-09 22:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('templatevalues', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('fkbootstrapconfig', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='stageit.BootstrapConfig')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('fktemplate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stageit.Template')),
            ],
        ),
        migrations.CreateModel(
            name='Log',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fkterminalserver', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='stageit.TerminalServer')),
            ],
            options={
